/*
 * Copyright (C) 2026 The Lunaris Project
 *
...
/** Helpers for selecting and hosting a third-party search widget in the hotseat dock. */
object DockSearchWidgetHelper {
    ...
    /**
     * A widget qualifies if it declares [WIDGET_CATEGORY_SEARCHBOX], or if it is a wide bar-style
     * widget whose app/class/label indicates search (e.g. Pixel Search without the category flag).
     */
    @JvmStatic
    ...
    /** Search dock widgets are horizontally oriented bars, not square icon tiles. */
    @JvmStatic
