...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val HOTSEAT_BOTTOM_SPACE_DEFAULT = backedUpItem("pref_hotseat_bottom_space_default", true)
        ...
        @JvmField val HOTSEAT_BG_STYLE = backedUpItem("pref_hotseat_bg_style", "off")
